...
sudo git clone https://github.com/ricardorub/richi_god_level_services.git
sudo mv richi_god_level_services services
...
sudo git clone https://github.com/ricardorub/richi_god_level_app.git
sudo mv richi_god_level_app  app
